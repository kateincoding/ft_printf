...
#    Updated: 2021/07/15 06:38:03 by ksoto            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC			=	stack_manipulation.c ft_printf.c handle_format.c validate_format.c select_functions.c ft_conversion_cs.c ft_conversion_diu.c ft_conversion_xX.c handle_print.c ft_conversion_p.c ft_flags_cs.c ft_flags_xX.c ft_flags_p.c ft_flags_diu.c set_flags_structure.c
